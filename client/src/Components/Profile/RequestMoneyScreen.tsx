...
//     console.log('💰 Requesting money from:', friendUsername, 'Amount:', amountToRequest);
...
//     try {
//       const response = await requestMoneyAPI(requesterUsername, friendUsername, Number(amountToRequest));
