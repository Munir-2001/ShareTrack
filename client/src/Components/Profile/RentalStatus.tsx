...
//   try {
//     const response = await fetch(`http://localhost:5001/api/rental/user/${userId}`);
...
//   location: string;
//   status: string;
//   rejection_reason?: string; // Only available if status is "rejected"
// }
...
//   approvedItem: {
//     borderLeftWidth: 6,
//     borderLeftColor: "#27AE60", // Green highlight for approved rentals
//     backgroundColor: "#e6f9e6",
//   },
//   underReviewItem: {
//     borderLeftWidth: 6,
//     borderLeftColor: "#F39C12", // Neutral highlight for under-review rentals
//     backgroundColor: "#fcf8e3",
//   },
//   rejectedItem: {
//     borderLeftWidth: 6,
//     borderLeftColor: "#E74C3C", // Red highlight for rejected rentals
